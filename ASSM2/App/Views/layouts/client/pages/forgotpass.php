              ...
              <div class="card-body">
                ...
                <form method="POST" action="?url=ResgisterController/handleRegister">
                  <div class="mb-3">
                    ...
                    <input type="email" name="email_forgot" class="form-control" id="exampleInputEmail1"
                  ...
                  <button type="submit" name="forgot" class="btn btn-primary w-100 py-8 fs-4 mb-4 rounded-2">Quên mật khẩu</button>
